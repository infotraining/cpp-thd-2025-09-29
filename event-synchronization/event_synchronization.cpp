...
int main()
{
    using ConditionVarsWithStopToken::Data;
    ...
    std::osyncstream(std::cout) << "Start of main..." << std::endl;
    {
        ...
        std::jthread thd_consumer_1{[&] { data.process(1, stop_src.get_token()); }};
        std::jthread thd_consumer_2{[&] { data.process(2, stop_src.get_token()); }};
